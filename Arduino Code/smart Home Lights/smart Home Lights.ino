...
#define BOT_TOKEN "5946599160:AAE_T4zsAgdoJ56ScR0wyZBcwHf28Zsyfhg"
#define CHAT_ID "789630357"

#define DHTPIN D4    // Pin where the DHT11 sensor is connected
#define DHTTYPE DHT11   // DHT11 sensor type
#define ServoMotorPin D3 
const char* ssid = "realme6"; // Enter your Wi-Fi network SSID
const char* password = "nahoma123"; // Enter your Wi-Fi network password
